...
import com.example.lookcow.databinding.ActivityPermisoBinding;
...
public class PermisoActivity extends DrawerBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            btnbuscar.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (txtid.getText().toString().trim().isEmpty()){
                        ocultarTeclado();
                        Toast.makeText(com.example.lookcow.Controladora.PermisoActivity.this, "Escriba una Identificacion para BUSCAR!!!", Toast.LENGTH_SHORT).show();
                        ...
                        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                if (!res){
                                    ocultarTeclado();
                                    Toast.makeText(com.example.lookcow.Controladora.PermisoActivity.this, "ID ("+auxId+") no encontrado!!", Toast.LENGTH_SHORT).show();
            ...
            btnbuscaAccion.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (txtAccion.getText().toString().trim().isEmpty()){
                        ocultarTeclado();
                        Toast.makeText(com.example.lookcow.Controladora.PermisoActivity.this, "Escriba una Accion para BUSCAR!!!", Toast.LENGTH_SHORT).show();
                        ...
                        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                if (!res){
                                    ocultarTeclado();
                                    Toast.makeText(com.example.lookcow.Controladora.PermisoActivity.this, "Permiso ("+permiso+") no encontrado!!", Toast.LENGTH_SHORT).show();
            ...
            btnmod.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (txtid.getText().toString().trim().isEmpty()
                        ...
                        ocultarTeclado();
                        Toast.makeText(com.example.lookcow.Controladora.PermisoActivity.this, "Campos en blanco, completar para Modificar", Toast.LENGTH_SHORT).show();
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                for (DataSnapshot tabla: snapshot.getChildren()){
                                    ...
                                    if (tabla.child("id").getValue().toString().equals(auxid)){
                                        ...
                                        Toast.makeText(com.example.lookcow.Controladora.PermisoActivity.this, "Registro modificado exitosamente!!", Toast.LENGTH_SHORT).show();
                                        txtid.setText("");
                                        txtAccion.setText("");
                                        txtDesc.setText("");
                                        listarPermisos();
                                ...
                                if(!res){
                                    ...
                                    ocultarTeclado();
                                    Toast.makeText(com.example.lookcow.Controladora.PermisoActivity.this, "Identificacion ("+auxid+") No encontrado.\nNo se puede modificar", Toast.LENGTH_SHORT).show();
                                    txtid.setText("");
                                    txtAccion.setText("");
                                    txtDesc.setText("");
            ...
            btnreg.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (txtid.getText().toString().trim().isEmpty()
                            ...
                            || txtDesc.getText().toString().trim().isEmpty()){
                        ocultarTeclado();
                        Toast.makeText(com.example.lookcow.Controladora.PermisoActivity.this, "Campos en blanco, completar!!", Toast.LENGTH_SHORT).show();
                    }else{
                        int id = Integer.parseInt(txtid.getText().toString());
                        String accion = txtAccion.getText().toString();
                        String desc = txtDesc.getText().toString();
                        ...
                        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                for (DataSnapshot tabla: snapshot.getChildren()){
                                    ...
                                    if (tabla.child("id").getValue().toString().equals(auxid)){
                                        res = true;
                                        ocultarTeclado();
                                        Toast.makeText(com.example.lookcow.Controladora.PermisoActivity.this, "Registro("+auxid+") ya existente", Toast.LENGTH_SHORT).show();
                                        break;
                                    }
                                ...
                                for (DataSnapshot x : snapshot.getChildren()){
                                    ...
                                    if (x.child("accion").getValue().toString().equals(accion)){
                                        res2 = true;
                                        ocultarTeclado();
                                        Toast.makeText(com.example.lookcow.Controladora.PermisoActivity.this, "La Accion ("+accion+") ya existe", Toast.LENGTH_SHORT).show();
                                        break;
                                    }
                                ...
                                if(!res && !res2){
                                    ...
                                    ocultarTeclado();
                                    Toast.makeText(com.example.lookcow.Controladora.PermisoActivity.this, "Permiso registrado correctamente", Toast.LENGTH_SHORT).show();
                                    txtid.setText("");
                                    txtAccion.setText("");
                                    txtDesc.setText("");
                            ...
                            @Override
                            public void onCancelled(@NonNull DatabaseError error) {
                                Toast.makeText(com.example.lookcow.Controladora.PermisoActivity.this, "Error al intentar registrar:" + error , Toast.LENGTH_SHORT).show();
                            }
                        });
            ...
            btneli.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (txtid.getText().toString().trim().isEmpty() ||
                            txtAccion.getText().toString().trim().isEmpty()){
                        ocultarTeclado();
                        Toast.makeText(com.example.lookcow.Controladora.PermisoActivity.this, "Buscar una Identificacion o una Accion para ELIMINAR!!!", Toast.LENGTH_SHORT).show();
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                for (DataSnapshot x : snapshot.getChildren()) {
                                    ...
                                    if (auxId.equalsIgnoreCase(x.child("id").getValue().toString())
                                        ...
                                        AlertDialog.Builder a = new AlertDialog.Builder(com.example.lookcow.Controladora.PermisoActivity.this);
                                        a.setCancelable(false);
                                        a.setTitle("ATENCION");
                                        a.setMessage("Estas por ELIMINAR el registro..");
                                        res[0] = true;
                                        Toast.makeText(com.example.lookcow.Controladora.PermisoActivity.this, "ID ( "+auxId+" ) con ( "+accion+" ) encontrado.\nUsted puede eliminar!!", Toast.LENGTH_SHORT).show();
                                ...
                                if (!res[0]){
                                    ocultarTeclado();
                                    Toast.makeText(com.example.lookcow.Controladora.PermisoActivity.this, "ID ( "+auxId+" ) con ( "+accion+" ) no encontrado.\nNo se puede eliminar!!", Toast.LENGTH_SHORT).show();
                                    txtid.setText("");
                                    txtAccion.setText("");
                                    txtDesc.setText("");
                                }
        ...
        private void listarPermisos(){
            ...
            ArrayAdapter<Permiso> adapter = new ArrayAdapter<Permiso>(com.example.lookcow.Controladora.PermisoActivity.this, android.R.layout.simple_list_item_1 , listPermiso);

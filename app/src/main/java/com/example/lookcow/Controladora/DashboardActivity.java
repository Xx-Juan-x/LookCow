...
public class DashboardActivity extends DrawerBaseActivity {
    ...
    private void generarGraficoVientres() {
        ...
        barChart.getXAxis().setGranularity(1f); // Espaciado en el eje X
    ...
    private List<Integer> getColoresTemperatura() {
        ...
        for (Temperatura temperatura : listaTemperatura) {
            ...
            if (tempActual > 39.5) {
                colores.add(ContextCompat.getColor(this, R.color.rojo)); // Rojo para > 39.5°C
            } else if (tempActual < 37.5) {
                colores.add(ContextCompat.getColor(this, R.color.azul)); // Azul para < 37.5°C
            } else {
                colores.add(ContextCompat.getColor(this, R.color.verde)); // Verde para valores entre 37.5 y 39.5°C
            }
        }
        return colores;
    }

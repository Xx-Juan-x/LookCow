...
import com.example.lookcow.databinding.ActivityRazaBinding;
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            for (DataSnapshot tabla : snapshot.getChildren()) {
                                ...
                                if (tabla.child("idRaza").getValue().toString().equals(auxid)) {
                                    ...
                                    Toast.makeText(com.example.lookcow.Controladora.RazaActivity.this, "Registro modificado exitosamente!!", Toast.LENGTH_SHORT).show();
                                    txtid.setText("");
                                    txtnombre.setText("");
                                    txtPelaje.setText("");
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            for (DataSnapshot x : snapshot.getChildren()) {
                                ...
                                if (auxId.equalsIgnoreCase(x.child("idRaza").getValue().toString())
                                    ...
                                    res[0] = true;
                                    Toast.makeText(com.example.lookcow.Controladora.RazaActivity.this, "ID ( "+auxId+" ) con ( "+nombre+" ) encontrado.\nUsted puede eliminar!!", Toast.LENGTH_SHORT).show();

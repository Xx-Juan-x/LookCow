...
import com.example.lookcow.Modelo.Usuario;
import com.example.lookcow.R;
import com.example.lookcow.Sesion.LoginActivity;
import com.example.lookcow.databinding.ActivityUsuarioBinding;
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            for (DataSnapshot tabla : snapshot.getChildren()) {
                                ...
                                if (tabla.child("email").getValue().toString().equals(auxid)) {
                                    ...
                                    Toast.makeText(com.example.lookcow.Controladora.UsuarioActivity.this, "Registro modificado exitosamente!!", Toast.LENGTH_SHORT).show();
                                    txtemail.setText("");
                                    txtdni.setText("");
                                    txtnom.setText("");
                                    txtape.setText("");
